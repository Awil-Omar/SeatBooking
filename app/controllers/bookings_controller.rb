class BookingsController < ApplicationController
  ...
  def create
    #creates a new booking type associated with the currently logged in user and saves it to the database.
  ...
  private
    ...
    def booking_params
      params.require(:booking).permit(:first_name, :last_name, :email, :start_at, :end_at, :duration)
    end
end
